...
export function MetricsSection() {
  ...
  return (
    <section ref={ref} className="border-y border-white/10 bg-[#07101f] px-5 py-16 text-white md:px-10 lg:px-14">
        ...
        <div className="grid gap-8 md:grid-cols-[0.62fr_1.38fr] md:items-center">
          ...
          <div className="grid gap-px overflow-hidden rounded-md border border-white/12 bg-white/12 md:grid-cols-4">
            {metricPlaceholders.map((label) => (
              <article className="bg-[#07101f] p-5" data-metric-card key={label}>
                <p className="font-mono text-xs uppercase tracking-[0.18em] text-white/42">Pendiente</p>
