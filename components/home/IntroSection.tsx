  ...
  return (
    <section className="relative overflow-hidden bg-[#F5FCFF] px-5 pb-20 pt-14 text-[#031B3A] md:px-10 md:pb-28 md:pt-20 lg:px-14">
      ...
      <div className="mx-auto max-w-[1540px]">
        <p className="font-mono text-sm font-bold uppercase tracking-[0.18em] text-[#005FCC] md:text-base md:tracking-[0.2em]">
        ...
        <div className="mt-8 grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-end">
          ...
          <div>
            <RevealText
              className="max-w-3xl text-[1.18rem] leading-[1.35] text-[#294761] md:text-3xl"
